export const sharedClassMap = {
    ...
    'js-btn-primary': 'inline-flex items-center justify-center w-full rounded-md bg-yellow-400 px-4 py-2 text-sm font-medium text-blue-900 transition-colors hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 cursor-pointer',
    ...
    'js-left-panel': 'md:w-1/2 flex items-center justify-center p-8 bg-cover bg-center',
    ...
    'js-body': 'min-h-screen flex items-center justify-center p-4 relative overflow-hidden',
    'js-bg-image-layer': 'fixed top-0 left-0 w-full h-full bg-cover bg-center bg-fixed opacity-10 -z-2 pointer-events-none',
    'js-radio': 'w-4 h-4 text-blue-600 focus:ring-blue-500',
    'js-radio-label': 'flex items-center cursor-pointer',
    'js-span': 'ml-2 text-gray-700',
    'js-span-sm': 'ml-2 text-gray-700 text-sm'
};
